...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image25": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/person_img.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image48": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/right_arrow.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image59": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/prod_design_1.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image60": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/prod_design_2.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image62": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/prod_design_4.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image61": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/prod_design_3.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image65": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/arrow_right_up.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image95": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/testimonial_person.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image107": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/email_footer.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox200": {
      "custom": {
        "text": "© All rights reserved. Conversionflow. Powered by "
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image110": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/webflow-badge-icon.svg"
      },
      "callbacks": {
        "onClick": [
          {
